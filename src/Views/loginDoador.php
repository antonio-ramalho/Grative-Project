...
<body>
    ...
    <header>
        <h1 class="text-split" aria-label="GRATIVE">
            <span class="bottom-layer" aria-hidden="true">GRATIVE</span>
            <span class="top-layer" aria-hidden="true">GRATIVE</span>
        </h1>
    </header>
        ...
        <form id="loginForm" method="post" action="/login">
            <div class="form-row">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="name" name="name" required placeholder="Digite seu Usuário">
                </div>
            </div>
